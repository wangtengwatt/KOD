...
function _errorI18nKeys(t: (key: string) => string) {
  ...
  t('You have exceeded the rate limit for the KOD service. Please try again later.')
  t(
  ...
  t('The {{model}} API itself does not support sending files. KOD processes text-based files (including code) locally.')
  t(
  ...
  t('KOD document parsing failed. Please try again later.')
  t(
