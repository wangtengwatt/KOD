...
const ExportChat = NiceModal.create(() => {
  ...
  return (
    ...
    >
      <Stack gap="md" p="sm">
        <div className="rounded-md border border-solid border-kod-border-warning bg-kod-background-warning-secondary px-sm py-xs">
          <Text size="sm" c="kod-warning" className="leading-snug">
