  ...
  return (
    <Stack gap="xxl" p="md">
        ...
        <Stack>
          ...
          <Flex align="center" gap="xs">
            ...
            {!!settings.userAvatarKey && (
              <Button color="kod-gray" size="xs" onClick={() => setSettings({ userAvatarKey: undefined })}>
                {t('Delete')}
              </Button>
            )}
          </Flex>
        ...
        <Stack gap="xs">
          ...
          <Flex align="center" gap="sm" wrap="wrap">
            {settings.backgroundImageKey ? (
              <Box w={160} h={90} className="overflow-hidden rounded bg-kod-tertiary/20 flex-shrink-0">
            ...
            <Flex gap="xs" align="center">
              ...
              {!!settings.backgroundImageKey && (
                <Button color="kod-gray" size="xs" onClick={() => setSettings({ backgroundImageKey: undefined })}>
                  {t('Remove')}
                </Button>
              )}
            </Flex>
      ...
      <Stack gap="md">
        ...
        {/* Display */}
        <Stack gap="sm">
          <Text c="kod-tertiary">{t('Display')}</Text>
        ...
        {/* Function */}
        <Stack gap="sm">
          <Text c="kod-tertiary">{t('Function')}</Text>
