        ...
        actions: [
          {
            ...
            leftSection: (
              <ScalableIcon icon={IconSquareRoundedPlusFilled} size={24} className="text-kod-tint-brand" />
            ),
          },
          {
            id: 'import-json',
            ...
            leftSection: <ScalableIcon icon={IconJson} size={24} className="text-kod-tint-brand" />,
          },
        ],
      },
      {
